...
%         break
    ...
    if ~is_first_plant
        ...
        if is_first_scene
            [pc_scene, tform_total, aligned_pc, rmse, rmse2] = test_registerPCs(0, pc_base, pc_new, 0, is_first_scene, merge, first_pc);
        else
            [pc_scene, tform_total, aligned_pc, rmse, rmse2] = test_registerPCs(pc_scene, pc_base, pc_new, tform_total, is_first_scene, merge, first_pc);
        end

...
data = load(fullfile('C:\Users\alexj\OneDrive - University of Warwick\3rd Year Project\Camera calibration', 'cameraParams.mat'));
cameraParams = data.cameraParams;

% Get intrinsic parameters of the camera
intrinsics = cameraIntrinsics(cameraParams.FocalLength, cameraParams.PrincipalPoint, cameraParams.ImageSize);
